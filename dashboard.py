...
# Load the data
file_path = "/Users/bashirchoucair/Desktop/merged_data.csv"
...
# Load and preprocess your data (replace 'your_data.csv' with your actual data)
file_path = "/Users/bashirchoucair/Desktop/merged_data.csv"
data = pd.read_csv(file_path)
...
if selected_task == "Forecasting":
    ...
    img = Image.open('/Users/bashirchoucair/Desktop/my_project/Process_flow.png')
   ...
   # Add a section for Data Analysis
    ...
    raw_data = pd.read_csv('/Users/bashirchoucair/Desktop/my_project/Fast_Food_Competitive_Jun2022_Dec2022.csv')

    # Load the data after annotation
    labeled_data = pd.read_csv('/Users/bashirchoucair/Desktop/my_project/merged_data.csv')
